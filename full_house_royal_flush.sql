...
insert into poker_hands (player_id, game_id, R1, R2, R3, R4, R5) 
values(66348,'45GOB','1S','KS','JS','QS', '10S'),
(66349,'45TOB','1S','1S','1S','1S', '4S'),
(66350,'45FOB','1S','KD','JS','QS', '10S'),
(66351,'45AOB','2S','KD','JS','QS', '9S'),
(66352,'45BOB','2S','KS','JS','QS', '9S'),
(66353,'45COB','1D','KD','JD','QD', '10D');
...
insert into poker_hands (player_id, game_id, R1, R2, R3, R4, R5) 
values(66354,'45DOB','1S','KD','KH','KS', '1H'),
(66355,'45EOB','1H','1S','1C','2S', '4S'),
(66356,'45GOB','1S','QS','1H','1D', '10S'),
(66357,'45HOB','2S','KD','JS','QS', 'QH'),
(66358,'45IOB','2S','2D','JS','QS', '9S'),
(66359,'45JOB','4D','4S','5D','4C', '5C');
